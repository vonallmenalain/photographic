...
| Adminbereich | Aufträge (inkl. „Bearbeiten“: Fotos jederzeit hinzufügen, umhängen, deaktivieren, löschen)/Zuordnung/E-Mails (je Auftrag)/Auswertung/Bestellungen (eine Kachel je Auftrag bzw. Schule, mit Suche, Auftragsfilter und Sortierung – siehe [`docs/06-betrieb.md`](docs/06-betrieb.md), Abschnitt 6.2a)/Meldungen/Produkte |
